 ...
 * serves the raw content same-origin under `/_worker/blog/*`. Fetching
 * same-origin avoids the COEP `credentialless` constraints that a cross-origin
 * CDN would introduce, and new posts appear without redeploying the app.
 *
...
/** Same-origin Worker namespace mapped to the R2 blog bucket. */
export const BLOG_CONTENT_BASE = "/_worker/blog";
