...
export const FIRST_PARTY_APPS: readonly FirstPartyAppDescriptor[] = [
  ...
  },
  {
    ...
    name: "Canvas Demos",
    version: "1.0.0",
    icon: HtmlInCanvasAppIcon,
    category: "dev",
    hidden: true,
    singleton: true,
    supportedShells: ["desktop"],
    defaultWindow: { width: 560, height: 440, centered: true },
    keywords: ["canvas", "demo", "glass", "shatter", "break", "flag", "widget"],
    widgets: [
      {
        id: "html-in-canvas:desktop",
        title: "Breaking Glass",
        description: "Shatter the desktop into glass shards.",
        icon: HtmlInCanvasAppIcon,
        surface: "desktop:wallpaper",
        size: "sm",
        defaultVisible: true,
        defaultPlacement: { gridX: 1, gridY: 1 },
        exportName: "BreakingGlassDesktopWidget",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    singleton: true,
    permissions: ["network.fetch"],
    defaultWindow: { width: 1120, height: 720, minWidth: 640, minHeight: 520, centered: true },
    chrome: { mobile: { titlebar: "hidden", edgeSwipe: "disabled" } },
    keywords: ["movies", "tmdb", "film", "tv", "series", "media"],
  },
  {
    id: "blog",
    name: "Blog",
